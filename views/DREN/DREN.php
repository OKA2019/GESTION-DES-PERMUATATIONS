...
<nav>
    ...
    <ul>
        ...
        <li><a href="index.php?page=permuteDREN"> permutation </a></li>
    ...
    <div class="corps" id="corps">
         <div >
            ...
            echo ' <marquee >La permutation de l\'année <b>', $date[1], '</b> sont ouvert du Code du <b>', $date[7], '</b> au <b>', $date[8], '</b>
                </marquee> ';
            ?>
        </div>
        <br><br><br>
        <div style="text-align:center; width:90%;margin-left:5%;margin-right:5%;">
                <?php 
                    include_once 'controllers/Con_dren/ConDren.php';
                    $ConDren->listeIEPUnique();
                ?>
        </div><br><br>
        <div style="text-align:center; width:90%;margin-left:5%;">
                <h3> Liste des des differents directions </h3><br>
